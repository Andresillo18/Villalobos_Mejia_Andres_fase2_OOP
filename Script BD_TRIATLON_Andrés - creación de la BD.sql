...
CREATE TABLE PROGRAMAS(
	...
	CUPO_PROGRAMA tinyint NOT NULL,
	TELEFONO_PROGRAMA varchar(15) NOT NULL,
	EMAIL_PROGRAMA varchar(40) NOT NULL,
	PROVINCIA_PROGRAMA varchar(20) NOT NULL DEFAULT 'ALAJUELA',
...
ALTER TABLE PROGRAMAS
	ADD CONSTRAINT CHK_CUPO CHECK (CUPO_PROGRAMA >=5);

ALTER TABLE PROGRAMAS
	ADD CONSTRAINT DF_CUPO DEFAULT 75 FOR CUPO_PROGRAMA;

ALTER TABLE PROGRAMAS
	ADD CONSTRAINT CHK_PROVINCIA_PROGRAMA CHECK (PROVINCIA_PROGRAMA = upper(PROVINCIA_PROGRAMA) AND PROVINCIA_PROGRAMA IN ('Alajuela', 'San José', 'Guanacaste', 'Puntarenas', 'Heredia', 'Cartago', 'Limón'));
